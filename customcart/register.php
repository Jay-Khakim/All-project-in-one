...
<div class="form-group row">
    ...
    <div class="col-sm-8">
	  ...
	  title="One number, one upper, one lower, one special, with more than 8 "
	  placeholder="Password" minlength="8"  required
	  value="<?php if (isset($_POST['password1'])) echo $_POST['password1']; ?>">
	  <span id='message'>One number, one upper, one lower, one special, with more than 8</span>
    </div>
  </div>
<div class="form-group row">
    ...
    <div class="col-sm-8">
	  ...
	  title="One number, one uppercase, one lowercase letter, with more than 8 "
