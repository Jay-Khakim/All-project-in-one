                        ...
                        <div class="page-title-heading">
                            <div class="breadcrumbs">
                                <ul class="trail-items">
                                    ...
                                    <li class="trail-item"><a href="news.php">Янгиликлар</a></li>
                                    <li class="trail-end">Бошқарув раисига оид янгиликлар</li>
                                </ul>                   
                            </div>
                    ...
                    <div class="flat-wrapper">
                        <div class="flat-portfolio portfolio-grid">
                            <ul class="portfolio-filter">
                                <li class="active"><a data-filter="*" href="#">Бошқарув раисига оид янгиликлар</a></li>
                            </ul><!-- /.project-filter -->
                            ...
                            <div class="portfolio"> 
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                            <img src="images/mnews/4.jpg" alt="images">
                                        </div>
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="m-news-sub.php">Нью-Йоркда савдо уйининг очилиши</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                            <img src="images/mnews/2.jpg" alt="images">
                                        </div>
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="#21">Мустақиллик Байрами муборак</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                            <img src="images/mnews/3.jpg" alt="images">
                                        </div>
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="#21">Ҳамкорликнинг янги босқичи</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                            <img src="images/mnews/1.jpg" alt="images">
                                        </div>
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="#21">Узбекмарт Платформаси ҳақида</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
