                        ...
                        <div class="page-title-heading">
                            <div class="breadcrumbs">
                                <ul class="trail-items">
                                    ...
                                    <li class="trail-end">Аъзолар рўйxати</li>
                                </ul>                   
                            </div>
                    ...
                    <div class="flat-wrapper">
                        <div class="flat-portfolio portfolio-grid">
                            <ul class="portfolio-filter">
                                <li class="active"><a data-filter="*" href="#">Барча аъзолар</a></li>
                            </ul><!-- /.project-filter -->
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                            <img src="images/portfolio/01.jpg" alt="images">
                                        </div>
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="com-1.php">«AGROPLACE» MЧЖ</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        ...
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="#21">«СHORSUV TSEMENT» MЧЖ</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        ...
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="#21">«Sanny Lund Export» MЧЖ</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        ...
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="#21">«Osborn Textille» MЧЖ</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-item item-four-column coaching consulting">
                                    <div class="portfolio-wrap">
                                        ...
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-wrap">
                                                <h6 class="portfolio-title">
                                                    <a href="#21">«Pulat Savdo Grup» MЧЖ</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
