...
$price = htmlspecialchars($_SESSION['price'], ENT_QUOTES);
$query =
...
<th scope="col"><b>Price &dollar;</b></th>
<th scope="col"><b>Cart</b></th>
</tr>
<?php
...
<input type="hidden" name="hosted_button_id" value="2CE7CQ2YXQYA2">
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
  ...
  // <a href="added.php?id=' . $art_id . '">Add </a>
