       ...
       <div class="content mx-auto" id="contents">
         <div class="row mx-auto" style="padding-left: 0px; height: auto; ">
           ...
           <div class="col-sm-12 text-center" style="padding: 20px; margin-top: 5px;">
             ...
             <div class="row">
               <h3>To arrange a viewing please use the Contact Us button on the menu and quote the reference number</h3>
               <?php
               try  {
                 require ('mysqli_connect.php'); //Connect tp the database
                 //Make a query
                 $query = "SELECT ref_number, location, thumb, price, mini_description, type, bedrooms, status FROM houses ";
                 if (($user_level == 1) && (!empty($_POST['ref_number']))) {
                 ...
                 if ($result) { //If it ran OK, display the records.
                   // Table header
                   ?>
                   <table class="table-responsive table-striped" style="background: white; color:black;">
                     <tr>
                       <th scope="col">Ref.</th>
                     ...
                     while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                       // Remove special characters that might already be in table to reduce tha chance of XSS exploits
                       ...
                       echo '<td scope="row">' . $row['price'] . '</td>
                          ...
                          <td scope="row"><a href="house_details.php?ref_number=' . $row['ref_number'] . '">Details</a></td>
               ...
               <div class="row mx-auto" style="padding-left: 0px; height: auto;">
                 <div class="COL-SM-12 text-center" style="padding: 0px; margin-top: 5px;">
                   <h5 class="text-center"> No houses displayed? Sorry we have nothing that matches your requirements at the moment</h5>
                 </div>
               </div>
