      ...
      <h5><?php
       ...
       try {
         ...
         if (isset($_GET['pages'])) {
          ...
          $records = $row[0];
          // Now calculate the nuber of pages
        ...
        // make a query
        $query = "SELECT ref_number, location, thubm, price, mini_description, bedrooms, status ";
        ...
        if ($result) { //IF it ran OK, display the record
          // Table header
          echo '<table class="table table-stripped table-sm" style="color: black; background-color: white;">
          <tr>
        ...
        if ($pages >1 ) {
          ...
          // vWhat number is the current page?
