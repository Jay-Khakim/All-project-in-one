     ...
     <div class="container" style="margin-top: 30px; border: 2px black solid;">
       ...
       <div class="" id="content">
         ...
         if ($_SERVER['REQUEST_METHOD'] == 'POST') {
           ...
           $query = "SELECT user_name, post_date, subject, message FROM forum WHERE MATCH (message) AGAINST (?) ORDER BY post_date ASC";
           ...
           if (mysqli_num_rows($result) > 0){
              ...
              ?>
              <table class="table table-responsive table-striped col-sm-12" style="background: white;color:black; padding-left: 50px;">
                <tr>
