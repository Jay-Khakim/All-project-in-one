...
// Assign the subject-->
<!-- This part of code will work only if it is uploded to web server which has PHP mail services -->
<!-- E-mails will not be sent and received using your computer unless a PHP e-mail service is provided.
