...
<div class="col-sm-8 row " style="padding-left: 30px;">
  ...
  try {
    ...
    // Make the query:
    $q = "SELECT bird_name, best_time, location, bird_hides, entrance_member, entr_non_member FROM birds INNER JOIN location USING (bird_id) INNER JOIN reserves_info USING (location_id)";
    ...
    if ($result){
      ...
      // Message
      echo '<p class="text-center"> The current data could not be retrieved.';
