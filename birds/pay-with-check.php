  ...
  <p>Thank you for registering online, now please fill out this
     ...
     <form class="" method="post">
       <div class="fields">
         ...
         <input type="text" id="title" name="title" size="35" value="" required> </label>
         <br><br>
         <label class="label" for="firstname">First Name <span>*</span>
          <input type="text" id="firstname" name="firstname" size="35" value="" required> </label>

          <br><br>
          <label class="label" for="lastname">Last Name <span>*</span>
           <input type="text" id="lastname" name="lastname" size="35" value="" required> </label>

           <br><br>
           <label class="label" for="useremail">Your Email Address <span>*</span>
            <input type="email" id="useremail" name="useremail" size="35" value="" required> </label>
       </div>
     </form>
     <br><br>
     <p class="sign">
     ...
     <br>
     <div id="button">
       <input type="button" name="" value="Click  to autotically print form in black and white" onclick="window.print()" title="Print this Form"><br>
     </div>
     <!-- End of content -->
</div>
