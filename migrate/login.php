        ...
        <div class="col-sm-8">
          ...
          <form action="login.php" name="loginform" id="loginform" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="password" class="form-control" id="password" name="password" placeholder="Password" maxlength="50" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,12}" title="One number, one upper, one lower, one special, with 8 to 12 characters" required value="<?php if (isset($_POST['password'])) echo $_POST['password']; ?>">
