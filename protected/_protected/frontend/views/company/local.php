...
<div class="container mt-4 mb-5 company">
    <div class="category-breadcrumb mt-0 py-1 px-3">
        ...
        >
        <a href="#"><?=t("Local companies")?></a>

    </div>
    <div class="row justify-content-center justify-content-md-start py-4 local_company_list">
...
$('.loading').click(function(){
  ...
  let companyCount = $('.local_company_list > div').length;
          let content = $('.local_company_list');
          // console.log(companyCount);
              $.ajax({
                ...
                success: function(res){
                 ...
                 if($('.local_company_list > div').length == res.allCount){
