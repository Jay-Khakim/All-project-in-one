...
$this->title = Yii::t('models', 'Companies');
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [
            [
                'url' => ['company-gallery/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('models', 'Company Gallery') . '</i>',
            ],
                                [
                'url' => ['company-translate/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('models', 'Company Translate') . '</i>',
            ],
                                [
                'url' => ['product/index'],
