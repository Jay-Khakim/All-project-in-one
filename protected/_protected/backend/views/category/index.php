...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [
            [
                'url' => ['category-translate/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('models', 'Category Translate') . '</i>',
            ],
                                [
                'url' => ['sub-category/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('models', 'Sub Category') . '</i>',
            ],
