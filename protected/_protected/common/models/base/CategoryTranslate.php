...
/**
 * This is the base-model class for table "category_translate".
 *
 * @property integer $id
 ...
 */
abstract class CategoryTranslate extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['title', 'lang_id', 'category_id'], 'required'],
